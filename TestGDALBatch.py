...
def TestGDALBatch():
    ...
    DataDirectory = "/home/smudd/SMMDataStore/analysis_for_papers/Chile_paper/SRTM_30metre/North_tiles"
    raster_format = "EHdr"
    target_format = "GTiff"
    merge_subfolder_name  = "North_merged"
    merge_filename = "ChileNorthMerged"
