...
#==============================================================================
def BasicDensityPlotGridPlot(FileName, thiscmap='gray',colorbarlabel='Elevation in meters',clim_val = (0,0)):
    ...
    im = grid[0].imshow(raster[::-1], thiscmap, extent = extent_raster, interpolation="nearest")
    #im = grid[0].imshow(raster, thiscmap, interpolation="nearest")
    cbar = grid.cbar_axes[0].colorbar(im)
    #grid.cbar_axes[0].set_label_text(colorbarlabel)
